    ...
    {food?.name && (
      <div className="flex items-start gap-2 md:justify-between">
        ...
        <div className="w-3/4 md:w-7/12 flex flex-col gap-1">
          ...
          className="md:hidden flex items-center gap-2 text-red-400 bg-red-50 border-red-400 px-2 rounded-lg py-1"> 
         {food.isAddedToCart ? (
                  "Added"
                ) : (
                  <>
        ...
        <div className="hidden md:block w-2/12">
            <button 
              onClick={addFoodToCart}
              disabled={food.isAddedToCart}
            className="flex items-center gap-2 text-red-400 bg-red-50 border-red-400 px-4 rounded-lg py-2"> 
           {food.isAddedToCart ? (
                "Added"
              ) : (
                <>
